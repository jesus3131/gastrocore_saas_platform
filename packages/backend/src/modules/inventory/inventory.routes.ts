...
router.delete('/ingredients/:id', requirePermission('inventory:delete'), inventoryController.deleteIngredient)
...
router.delete('/recipes/:id', requirePermission('inventory:delete'), inventoryController.deleteRecipe)
