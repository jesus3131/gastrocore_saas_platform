...
import { requirePermission, requireRole } from '../../common/guards/permission.guard.js'
...
router.delete('/employees/:id', requirePermission('hr:delete'), requireTenantAdmin, controller.deleteEmployee.bind(controller))
